...
This is where ',@' comes into play. Instead of the standard ~unquote~
behaviour, it unquotes expressions and splices in the values.
...
Note that ',@' is shorthand for ~unquote-splice~.
